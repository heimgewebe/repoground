...
<<<<<<< HEAD
        ...
        "navigation_refs": [
            ...
            {"kind": "repo_path", "target": "merger/lenskit/core/citation_map.py"},
            {"kind": "repo_path", "target": "merger/lenskit/core/range_resolver.py"},
        ],
    },
    {
=======
>>>>>>> b9ef24ec (fix: close audit guard gaps)
    ...
    },
    {
        ...
        "navigation_refs": [
            {"kind": "repo_path", "target": "merger/lenskit/core/citation_map.py"},
            {"kind": "repo_path", "target": "merger/lenskit/core/citation_validate.py"},
            {"kind": "repo_path", "target": "merger/lenskit/core/bundle_surface_validate.py"},
        ],
    },
    {
        "card_type": "query",
