...
from merger.lenskit.cli.agent_impact import main as impact_cli_main
...
def _impact_adapter(
    tmp_path: Path,
) -> tuple[RepoBriefAgentImpactAdapter, dict, Path]:
    ...
    return RepoBriefAgentImpactAdapter.from_config(config), bundle, config
