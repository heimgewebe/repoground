...
The local semantic re-ranking feature (F1b) remains opt-in. RepoBrief's default
...
`merger/lenskit/requirements-semantic.txt` records the root intent only; it is
