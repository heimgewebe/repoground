...
from merger.repoground.core.repobrief_profiles import (
    evaluate_profile,
...
def register_repobrief_command_groups(repobrief_parser: argparse.ArgumentParser) -> None:
    ...
    snapshot_parser = repobrief_subparsers.add_parser("snapshot", help="RepoGround snapshot commands")
    ...
    preflight_parser = repobrief_subparsers.add_parser("preflight", help="Run RepoGround consumption preflight")
    ...
    artifact_parser = repobrief_subparsers.add_parser("artifact", help="RepoGround artifact read-only commands")
    ...
    reading_parser = repobrief_subparsers.add_parser("required-reading", help="RepoGround required-reading commands")
...
def run_latest_complete_write(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_latest_complete import write_latest_complete_registry
...
def run_latest_complete_status(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_latest_complete import latest_complete_status
...
def run_workbench_eval(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_workbench_usefulness import (
...
def run_snapshot_check(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_access import snapshot_check
...
def run_artifact_get(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_access import get_artifact
...
def run_artifact_list(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_access import list_artifacts
...
def run_required_reading_resolve(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_access import resolve_required_reading_for_bundle
...
def run_query_existing_index(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_access import query_existing_index
...
def run_ask(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_ask import (
...
def run_ask_eval(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_ask_eval import evaluate_ask_goldset
...
def run_symbol_search(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_access import search_symbol_index
...
def run_review_coverage_compile(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_review_coverage import compile_review_coverage
...
def run_delta_context_compile(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_delta_context import compile_delta_context
...
def run_context_compile(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_context_compiler import compile_context_plan
...
def run_preflight(args: argparse.Namespace) -> int:
    from merger.repoground.core.repobrief_preflight import run_consumption_preflight
...
def build_snapshot_create_result(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if (
        ...
        from merger.repoground.core.repobrief_latest_complete import (
