"""RepoGround HTTP service client. No new runtime dependencies."""
import argparse
import json
import os
import pathlib
...
def register_service_client_commands(subparsers: argparse._SubParsersAction) -> None:
    ...
    run_parser = client_subparsers.add_parser(
        "run", help="Create or reuse a RepoGround bundle job"
    )
    ...
    run_parser.add_argument(
        ...
        default=None,
        help=(
            "RepoGround source acquisition mode. local-current scans the working tree as-is; "
