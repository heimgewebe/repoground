...
# Import core logic.
# Since this file is in merger/repoground/service/runner.py,
# and merger/repoground is usually in sys.path when running repolens.py.
...
class JobRunner:
    ...
    def _run_job(self, job_id: str) -> None:
        ...
        try:
            ...
            #
            # RepoGround source acquisition v1: the effective source mode decides how the
