...
def calculate_job_hash(req: "JobRequest", hub_resolved: str, version: str) -> str:
    ...
    sig = {
        ...
        # RepoGround service source acquisition (v1). These select how the on-disk content to
...
class JobRequest(BaseModel):
    ...
    # RepoGround source acquisition v1. Selects how the content to scan is acquired:
