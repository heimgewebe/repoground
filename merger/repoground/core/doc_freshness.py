...
RepoGround already has *drift awareness* (the artifact-drift-matrix, the two-layer
...
implemented (the ``ExtrasConfig`` case in ``repoground-build-spec.md``) and nothing
notices.
...
from merger.repoground.core.yaml_compat import (
...
def repo_root_from_here() -> Path:
    """Best-effort repo root: ``merger/repoground/core/doc_freshness.py`` → root."""
