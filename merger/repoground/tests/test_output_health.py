"""Tests for merger.repoground.core.output_health."""
...
from merger.repoground.core.output_health import compute_output_health, write_output_health
from merger.repoground.tests.bundle_fixtures import (
...
def test_range_ref_jsonschema_unavailable_is_warn_not_fail(tmp_path):
    ...
    with (
        patch(
            "merger.repoground.core.range_resolver.resolve_range_ref",
            side_effect=_raise_jsonschema_unavailable,
        ),
        patch("merger.repoground.core.range_resolver.jsonschema", None),
    ):
        result = compute_output_health(
...
def test_range_ref_jsonschema_unavailable_verdict_is_warn_not_pass(tmp_path):
    ...
    with (
        ...
        patch("merger.repoground.core.range_resolver.jsonschema", None),
        patch("merger.repoground.core.output_health._JSONSCHEMA_AVAILABLE", False),
    ):
        result = compute_output_health(
...
def test_output_health_dependencies_reports_jsonschema_available(monkeypatch):
    monkeypatch.setattr("merger.repoground.core.output_health._JSONSCHEMA_AVAILABLE", True)
...
def test_output_health_dependencies_reports_jsonschema_unavailable(monkeypatch):
    monkeypatch.setattr("merger.repoground.core.output_health._JSONSCHEMA_AVAILABLE", False)
...
def test_output_health_reports_degradation_summary_for_jsonschema_skip(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("merger.repoground.core.output_health._JSONSCHEMA_AVAILABLE", False)
    with (
        patch("merger.repoground.core.range_resolver.resolve_range_ref", side_effect=_raise_jsonschema_unavailable),
        patch("merger.repoground.core.range_resolver.jsonschema", None),
    ):
        result = compute_output_health(
