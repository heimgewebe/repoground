...
from merger.repoground.core.doc_freshness import (
    DocFreshnessReport,
    EntryResult,
    EvidenceRef,
    classify_entry,
...
def resolve_evidence_stub(kind, *, satisfied, implies=None):
    from merger.repoground.core.doc_freshness import EvidenceResult
...
def test_load_registry_installs_pyyaml_collections_compat_before_safe_load(
    ...
    from merger.repoground.core import doc_freshness
...
@pytest.fixture
def real_registry():
    from merger.repoground.core.doc_freshness import default_registry_path
