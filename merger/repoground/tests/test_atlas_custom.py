...
def test_atlas_scan_root_allowed(service_client):
    ...
    with patch("merger.repoground.service.app.get_security_config") as mock_get_sec, \
         patch("merger.repoground.service.app.AtlasScanner") as MockScanner, \
         patch("merger.repoground.service.app.render_atlas_md") as mock_render, \
         patch("merger.repoground.adapters.filesystem.get_security_config") as mock_fs_sec:
