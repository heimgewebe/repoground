"""
Tests for merger.repoground.core.citation_map (Citation Map Producer).
...
class TestManifestWiring:
    ...
    def test_contract_registry_has_citation_map_entry(self):
        from merger.repoground.core.merge import ARTIFACT_CONTRACT_REGISTRY
    ...
    def test_authority_registry_has_citation_map_entry(self):
        from merger.repoground.core.merge import ARTIFACT_AUTHORITY_REGISTRY
...
class TestLiveRepoAddress:
    def test_producer_emits_live_repo_address_when_provenance_present(self, tmp_path):
        ...
        assert address["repo_remote"] == "git@github.com:heimgewebe/repoground.git"
