...
from merger.repoground.core.claim_evidence_map import (
...
def _registry_fixture() -> dict:
    return {
        ...
        "entries": [
            {
                "id": "b-open",
                "doc": "docs/roadmap/repoground-master-roadmap.md",
                "locator": "Phase 5",
                "claim": "Open claim",
                "status": "partial",
                "normative": False,
            ...
            {
                "id": "a-done",
                "doc": "docs/architecture/system-map.repoground.md",
                ...
                "evidence": [
                    {
                        "kind": "symbol",
                        "target": "merger/repoground/core/x.py::Thing",
                    }
                ],
            },
        ],
...
def test_build_claim_evidence_map_is_deterministic_and_preserves_evidence_shape():
    ...
    assert done["evidence_refs"] == [
        {"kind": "symbol", "target": "merger/repoground/core/x.py::Thing"}
    ]
