...
from merger.repoground.core.runtime_provenance import build_runtime_provenance
...
def test_build_runtime_provenance_has_drift_fields():
    ...
    assert rt["module"] == "merger.repoground.core.merge"
...
def test_runtime_provenance_skips_git_subprocess_probe_on_ios(monkeypatch):
    from merger.repoground.core import runtime_provenance as rp
    ...
    assert runtime["module"] == "merger.repoground.core.merge"
