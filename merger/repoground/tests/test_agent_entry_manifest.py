...
from merger.repoground.core.agent_entry_manifest import build_agent_entry_manifest
...
def test_produce_agent_entry_manifest_writes_default_output(tmp_path, schema):
    from merger.repoground.core.agent_entry_manifest import produce_agent_entry_manifest
