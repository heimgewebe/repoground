...
from merger.repoground.core.merge import FileInfo, SKIP_DIRS, _BUILD_AND_CACHE_DIRS
...
def test_noise_dirs_absent_from_generated_bundle_surfaces(tmp_path):
    ...
    """
    from merger.repoground.core.merge import write_reports_v2, ExtrasConfig
