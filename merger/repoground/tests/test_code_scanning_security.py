...
from merger.repoground.core.federation import add_bundle, init_federation
...
from merger.repoground.retrieval.federation_query import execute_federated_query
...
def test_security_config_rejects_symlink_escape_from_narrower_root(tmp_path):
    from merger.repoground.adapters.security import AccessDeniedError, SecurityConfig
...
def test_security_config_rejects_parent_segments_before_normalization(tmp_path):
    from merger.repoground.adapters.security import InvalidPathError, SecurityConfig
