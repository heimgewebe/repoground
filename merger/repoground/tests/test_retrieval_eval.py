...
from merger.repoground.cli import cmd_eval
from merger.repoground.retrieval import index_db, eval_core
import jsonschema
...
def test_schema_smoke():
    ...
    # structure: merger/repoground/tests/test_retrieval_eval.py
    # target: merger/repoground/contracts/retrieval-eval.v1.schema.json
    # ../../contracts/
