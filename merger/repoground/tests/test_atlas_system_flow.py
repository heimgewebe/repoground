...
from merger.repoground.service.app import app, init_service, state, verify_token
...
def mock_state():
    ...
    with patch("merger.repoground.service.app.get_security_config") as mock_get_sec:
...
def test_atlas_system_root_mapping(mock_state):
    ...
    with patch("merger.repoground.service.app.AtlasScanner") as MockScanner:
        with patch("merger.repoground.service.app.render_atlas_md") as mock_render:
