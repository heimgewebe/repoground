...
from merger.repoground.core import repobrief_latest_complete as latest_complete
...
def test_latest_complete_registry_schema_accepts_emitted_registry(tmp_path):
    ...
    schema = json.loads(
        Path(
            "merger/repoground/contracts/repobrief-latest-complete-registry.v2.schema.json"
