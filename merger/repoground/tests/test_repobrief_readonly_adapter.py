...
from merger.repoground.core import repobrief_readonly_adapter as adapter_module
from merger.repoground.core.repobrief_readonly_adapter import (
    RepoBriefReadonlyAdapter,
    RepoBriefReadonlyAdapterError,
)
from merger.repoground.tests.test_repobrief_resolved_evidence_query import (
