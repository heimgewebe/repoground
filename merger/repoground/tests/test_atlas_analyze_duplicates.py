...
from merger.repoground.cli.cmd_atlas import _run_analyze_duplicates
...
def duplicate_snapshot_setup(tmp_path, monkeypatch):
    ...
    import merger.repoground.atlas.paths
    monkeypatch.setattr(merger.repoground.atlas.paths, "resolve_atlas_base_dir", mock_resolve_base)
