...
from merger.repoground.core.relation_cards import produce_relation_cards
from merger.repoground.core.relation_card_validate import (
...
class TestCoherenceLayer:
    ...
    def test_source_validation_error_preserves_diagnostics(self, monkeypatch):
        from merger.repoground.core.relation_cards import SourceValidationError
