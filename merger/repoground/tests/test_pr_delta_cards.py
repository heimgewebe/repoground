import pytest
from merger.repoground.core.pr_delta_cards import (
...
class TestSingleProduction:
    ...
    def test_multi_facet(self):
        delta = _valid_source_delta([_changed_file("merger/repoground/tests/test_x.py")])
        card = produce_pr_delta_card(delta, "merger/repoground/tests/test_x.py")
...
class TestContractParity:
    def test_schema_parity(self):
        contracts_dir = Path("merger/repoground/contracts")
