...
from merger.repoground.atlas.diff import (
    compute_snapshot_delta,
    _compare_file_sets,
    _load_inventory_index,
    compute_snapshot_comparison
)
from merger.repoground.atlas.paths import resolve_artifact_ref
...
def test_resolve_snapshot_ref(populated_registry):
    from merger.repoground.cli.cmd_atlas import _resolve_snapshot_ref
...
def test_cli_diff_routing(temp_workspace, populated_registry, capsys):
    tmp_path, registry_db = temp_workspace
    import argparse
    from merger.repoground.cli.cmd_atlas import run_atlas_diff
