...
| 2 | Range-Ref v2 + Schema nicht implementiert; v1 erzeugt Fehlzitate | **done** | `contracts/range-ref.v2.schema.json`; `core/range_resolver.py:57` `build_explicit_range_ref_v2`, `:117` `build_derived_range_ref_v2`, v2-Pfad `:172–325` inkl. v1-Legacy-Alias-Konsistenzprüfung `:197`; Tests `test_range_resolver.py`, `test_range_ref_backwards_compat.py` |
