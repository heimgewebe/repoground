...
- data current as of (max last_verified): 2026-06-02
- overall: **PASS**
...
| :-- | :-- | :-- | :-- | :-- | :-- |
| `agent-reading-pack-v2-claim-evidence-map` | done | ✅ consistent | `docs/roadmap/lenskit-master-roadmap.md` | Agent Reading Pack v2 claim_evidence_map is produced (Arbeitspaket F) | 2026-06-02 |
| `repolens-spec-super-merger-extras` | done | ✅ consistent | `merger/lenskit/repoLens-spec.md` | Super-Merger extras (ExtrasConfig + extras flags) are implemented | 2026-06-02 |
| `system-map-federation-exists` | done | ✅ consistent | `docs/architecture/system-map.lenskit.md` | Federation modules exist in the source tree | 2026-06-02 |
