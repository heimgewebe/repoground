# Deterministic RepoGround Core

## Status and purpose

This document is the normative boundary for RepoGround's promoted/default
...
RepoGround is a deterministic lens apparatus for language models, coding agents,
...
repository bytes, a deterministic RepoGround producer must emit the same semantic
